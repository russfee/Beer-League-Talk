...
<div class="row <?php the_sub_field('row_width'); ?>">
<div class="callout-io-container" style="<?php the_sub_field('row_padding_top'); ?><?php the_sub_field('row_padding_bottom'); ?>">
	...
	<?php if(get_sub_field('image_io_repeater')): ?>
					...
					<?php while(has_sub_field('image_io_repeater')): ?>
						...
						<a href="#"><div class="callout-io-image" style="background-image: linear-gradient(<?php the_sub_field('tint_image'); ?>), url(<?php the_sub_field('image'); ?>); <?php the_sub_field('circle'); ?> <?php the_sub_field('image_spacing'); ?> ">
